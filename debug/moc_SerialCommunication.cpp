...
QT_MOC_LITERAL(5, 51, 20) // "slot_handleReadyRead"

    },
    "SerialCommunication\0dataReceived\0\0"
    "QByteArray&\0data\0slot_handleReadyRead"
};
...
void SerialCommunication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slot_handleReadyRead(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialCommunication::*)(QByteArray & );
...
// SIGNAL 0
void SerialCommunication::dataReceived(QByteArray & _t1)
{
